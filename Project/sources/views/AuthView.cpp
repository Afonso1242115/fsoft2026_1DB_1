...
std::string AuthView::askName() const {
    return readString("Name: ");
}

std::string AuthView::askEmail() const {
    return readString("Email: ");
}

std::string AuthView::askPassword() const {
    return readString("Password: ");
}

void AuthView::showInvalidName() const {
    std::cout << "Name must have at least 3 characters.\n";
}

void AuthView::showInvalidEmail() const {
    std::cout << "Email must contain @ and .\n";
}
...
void AuthView::showLoginSuccess(const User* user) const {
